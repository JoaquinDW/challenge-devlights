...
export default function Home() {
  ...
  return (
    <>
      <Hero />
      <main className="">
        <section className="flex justify-center container mt-2">
          <div className="m-4 p-1 rounded-md  bg-gradient-to-r from-yellow-500 via-rose-500 to-indigo-500 w-[500px]">
            <input
              className="p-3 w-full rounded-md w-full focus:outline-none bg-black text-white placeholder:text-red-400 placeholder:text-xl mx-auto "
              type="text"
              placeholder="Search..."
